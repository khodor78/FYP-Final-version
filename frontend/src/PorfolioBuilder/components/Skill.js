...
import ExperienceDetails from '../subComponents/ExperienceDetails';
import AboutDetails from '../subComponents/AboutDetails';
import SkillDetails from '../subComponents/SkillDetails';
...
Navigate('/Social-Media');
  ...
  const back = () =>{
    ...
    return (
      ...
      <Paper  >
        <Card>
          <CardHeader id="title" title="About Details" />
        </Card>
<SkillDetails   />
